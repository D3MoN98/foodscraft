...
<footer class="padding-top-40 padding-bottom-40">
    <div class="fo-shapes">
        ...
        <span class="fs-2 item-animateTwo"><img src="{{asset('images/shapes/25.png')}}" alt=""></span>
        <span class="fs-3 item-animateTwo"><img src="{{asset('images/shapes/26.png')}}" alt=""></span>
        <span class="fs-4 item-animateOne"><img src="{{asset('images/shapes/27.png')}}" alt=""></span>
        <span class="fs-5 item-bounce"><img src="{{asset('images/shapes/3.png')}}" alt=""></span>
